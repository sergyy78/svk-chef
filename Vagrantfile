...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sergyy78-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/svk-org"
  #   chef.validation_client_name = "svk-org-validator"
  #   chef.validation_key_path = ".chef/svk-org-validator.pem"
  # end
end
